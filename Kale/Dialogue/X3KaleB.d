...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleBranwen1","GLOBAL",0)~ THEN BBRANW X3KaleBranwen1
...
== BBRANW @23 // ~I've a newfound respect. Tempus would bless you.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleCoran1","GLOBAL",0)~ THEN BCORAN X3KaleCoran1
...
== BCORAN @27 // ~I've not heard of Wyverns around the particular village you hail from.~
...
== BCORAN @29 // ~You tell taller tales than a bard, my friend. But luck is always on the side of the romantic.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleDynaheir1","GLOBAL",0)~ THEN BDYNAH X3KaleDynaheir1
...
== BDYNAH @32 // ~He's served me well so far, but his rodent is...~
== X3KaleB @33 // ~That hamster? I think if he fattened it up a bit it'd be a great warrior pet!~
== BDYNAH @34 // ~Thou has more in common than just strength alike, it seems.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleEdwin1","GLOBAL",0)~ THEN BEDWIN X3KaleEdwin1
...
== BEDWIN @37 // ~You are mistaken, little monkey, go bother someone else. (As if I would explain it to him.)~
== X3KaleB @38 // ~There you go again, mate. Something wrong with you?~
== BEDWIN @39 // ~I said stop bothering me, before you become crushed beneath my toes.~
...
== BELDOT @42 // ~Listen here, Kale. You're just not up to my level of charm and wit to earn the gift of my music, yet.
== BELDOT @440 // ~Your game is in need of work, to put it nicely.~
== X3KaleB @441 // ~Yeah? You got suggestions, mate?~
== BELDOT @442 // ~Drop the hero act. It's out-dated. Just be a man that conquerors as he pleases.~
...
== BFALDO @45 // ~They destroy it, and nature in turn shall destroy them.~
== X3KaleB @46 // ~That so? What about the little men, eh?~
== BFALDO @47 // ~I know few of your people, why would they be different?~
== X3KaleB @48 // ~Well, Yondalla reminds us nature is our provider, can't be ungrateful, you know.~
== BFALDO @49 // ~You've my respect halfling... if that is true.~
EXIT
...
== BGARRI @51 // ~Your might for one so small would be song-inspiring, but the words have not come to me.~
== X3KaleB @52 // ~Words, eh? I like stupendous, phenomenal, amazing, jaw-dropping!~
== BGARRI @53 // ~They lack musical ring, Kale.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleImoen1","GLOBAL",0)~ THEN BIMOEN X3KaleImoen1
...
== BIMOEN @56 // ~Didn't you say it was the Baron of Nashkel?~
== X3KaleB @57 // ~Did I? You know, that might have been it.~
== BIMOEN @58 // ~You're a bit quacky, you know that?~
...
== BIMOEN @62 // ~And I'll have fun finding your bluff in it, bufflehead.~
...
== BJAHEI @65 // ~You are reckless, Kale. Charging in with fury and anger.~
== X3Kale @66 // ~Last to the fight is last to the glory, lass.~
== BJAHEI @67 // ~There will be no glory if you are dead.~
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleKivan1","GLOBAL",0)~ THEN BKIVAN X3KaleKivan1
...
== BKIVAN @73 // ~Sometimes I wish I maintained such routine, if only to have my love with me still.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleMinsc1","GLOBAL",0)~ THEN BMINSC X3KaleMinsc1
...
== BMINSC @777 // ~Boo approves of your mighty cry, little Kale. Pride he feels.~
== X3KaleB @78 // ~Aye. Boo and I know that the smallest are the mightiest.~
== BMINSC @79 // ~The three of us will be unstoppable. Evil will quake in their boots!~
...
== BMONTA @82 // ~Shut up and don't call me Monty.~
== X3KaleB @83 // ~Sure, sure, Monty.~
== BMONTA @84 // ~I hope you're a light sleeper.~
...
== BMONTA @88 // ~Aye, I'll bring one, shaped like a dagger.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleQuayle1","GLOBAL",0)~ THEN BQUAYL X3KaleQuayle1
...
== BQUAYL @92 // ~Romp? Is that some halfling slang?~
...
== BQUAYL @95 // ~My brain is far evolved beyond such things!~
...
== BSAFAN @994 // ~Keep with the short woman and turn your game into the fish you can actually catch, Kale. 
== X3KaleB @995 // ~Ouch. Think my heart shattered a bit there.~
== BSAFAN @996 // ~You're a strong man, Kale, but I prefer big men.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleSharTeel1","GLOBAL",0)~ THEN BSHART X3KaleSharteel1
...
== BSHART @9994 // ~You're funny Kale. Don't worry, I'll gut yours off last.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleSkie1","GLOBAL",0)~ THEN BSKIE X3KaleSkie1
...
== BSKIE @98 // ~I've my comfortable bed and perfumes, and all my clothes.~
...
== BSKIE @101 // ~Why are you being mean?~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleTiax1","GLOBAL",0)~ THEN BTIAX X3KaleTiax1
...
== BTIAX @107 // ~Tiax will be served by all, men or women, even you. Cyric will reward Tiax well.~
...
== BVICON @110 // ~I am flattered... Darthiir. Thank you.~
== X3KaleB @111 // ~That said and all, most of us would kill you. Is it that bad down there that it's worth the risk?~
== BVICON @112 // ~You have no idea, little one. If you were in the underdark, you would be fodder for the creatures within.~
...
== BXANNN @120 // ~Yet around you, I almost think we have a chance.~
== BXANNN @121 // ~Perhaps it's that halfling go lucky feel.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleYeslick1","GLOBAL",0)~ THEN BYESLI X3KaleYeslick1
...
== BYESLI @130 // ~Hardy as rock, brave as a honey badger surrounded by wolves.~
== BYESLI @131 // ~If only they were here. You would have gotten along.~
...
== BALORA @143 // ~Are you going to share what's ailing you now?~
...
== BALORA @146 // ~It's not always like that, Kale. Some people get happy endings!~
== X3KaleB @147 // ~Maybe I've just been very unlucky. An unlucky halfling! Unheard of, isn't it?~
== BALORA @148 // ~Stick around with me, and I'll rub my happy go lucky on you. There's a smile!~
...
Global("X3KaleDynaheir1","GLOBAL",1)~ THEN BDYNAH X3KaleDynaheir2
...
== BDYNAH @153 // ~It's warming to see from thou.~
== X3KaleB @154 // ~Thanks mate. And sorry as well, knew you always had your own eye on me.~
== BDYNAH @155 // ~Thou'rt really skilled at being pesky.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleImoen1","GLOBAL",1)~ THEN BIMOEN X3KaleImoen2
...
== BIMOEN @159 // ~Oh pooh, you must have some completely true tale up in that head of yours.~
...
== BIMOEN @162 // ~Hee, maybe, but I'd like to hear 'bout a battle with a single goblin, too.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleJaheira","GLOBAL",0)~ THEN BJAHEI X3KaleJaheira2
...
== BJAHEI @167 // ~I hope it sticks. This side of you is much more appealing to see.~
EXIT
...
== BKAGAI @169 // ~Against who?~
== X3KaleB @170 // ~Against me! I'll put up half of my share of the gold if you put up half of yours!~
== BKAGAI @171 // ~Against a dwarf?! You're a moron. I'll take your bet, that's easy gold.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleMinsc1","GLOBAL",1)~ THEN BMINSC X3KaleMinsc2
...
== BMINSC @175 // ~Forge we many adventurers, tales spread everywhere!~
== X3KaleB @176 // ~Aye. Carved from the same tree we are, mate, ha! May our friendship be long and full of swooning lasses!~
== BMINSC @177 // ~You lost me on the last bit, a bit ducky you are, friend.~
...
== BMONTA @180 // ~It's Montaron, you idiot, or do you want to see my dagger up and close.~
...
== BMONTA @183 // ~I can show you what is my "cup of tea" precisely.~
...
Global("X3KaleTiax1","GLOBAL",1)~ THEN BTIAX X3KaleTiax2
...
== BTIAX @187 // ~Ah, so the world is still Tiax's. You will make fine guards for Tiax for his throne.~
...
== BYESLI @190 // ~Stone is our blood, lad. The love of the mountain, and all its splendor and treasure.~
== X3KaleB @191 // ~Seems more trouble than its worth if you ask me.~
== BYESLI @192 // ~Hard labor, but it's honest labor. Honorable work.~
== X3KaleB @193 // ~Nothing a bard will sing about though.~
== BYESLI @194 // ~Many a dwarven ministrel might say otherwise. The glorious pursuits of life are not thee only ones worthy of art.~
...
== BKHALI @197 // ~Uh, I d-don't understand what you mean.~
== X3KaleB @198 // <CHARNAME> is nice and all, but look at me. I'm far more interesting to work for, eh?~
== BKHALI @199 // ~I'd r-rather not work for anyone, if htat's all right.~
...
== BALORA @210 // ~Mhm. Everyone deserves sweetness and kindness.~
== X3KaleB @211 // ~We aren't talking about the same thing, are we sugar cube?~
== BALORA @212 // ~What are you trying to say?
...
== BMINSC @215 // ~Yes, mighty little one?~
== X3KaleB @216 // ~You ever thought of setting up Boo? What gender is Boo anyway? He, she?~
== BMINSC @217 // ~Setting up Boo? In Armor? A mighty idea. We should find blacksmith, so he may charge in with steel plate and razor teeth.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleKagain1","GLOBAL",2)~ THEN BKAGAI X3KaleKagain3
...
== BKAGAI @221 // ~If you want a second chance, it's on your money this time.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleAlora1","GLOBAL",3)~ THEN BALORA X3KaleAlora3
...
== BALORA @227 // That's kind to ask, but it's dangerous adventuring times.~
...
== BALORA @229 // ~Okay, why not then? You're sweet like candy. Let's see where this goes.~
...
== BMONTA @232 // ~What are you talking about now?~
...
== BMONTA @234 // ~There is no connection! You are almost as bothersome as the necromancer.~
== X3KaleB @235 // ~My heart breaks, mate, it breaks. Damn this is fun!~ 
== BMONTA @236 // ~Where's my dagger?!~
...
CombatCounter(0)
!See([ENEMY])
Global("X3KaleAlora1","GLOBAL",4)~ THEN BALORA X3KaleAlora4
...
== BALORA @240 // ~Across mountains, seas, cities, everywhere!~
...
== BALORA @244 // ~Borrowing shiny things!~
